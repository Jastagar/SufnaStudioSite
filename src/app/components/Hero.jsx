...
export default function Hero() {
  ...
  return (
    <div className='h-[70dvh] md:p-20 lg:p-40' id='home'>
        <div className='flex justify-between items-center h-full text-center md:text-start'>
          {/* Heading */}
          <div data-aos="fade-left" className='flex items-center h-full'>
            <div className='md:text-7xl text-xl font-bold leading-[-0.25px] m-10'>
              We make your Stories,<br/><span className='text-emerald-600'>Your Stories make us</span>
              <div className='font-medium md:text-xl text-base'>
                ...
                <span className='text-emerald-600 md:text-2xl text-lg my-2'>
                ...
                <div className='flex justify-center gap-6 m-4 flex-col items-center md:flex-row'>
                  <Link href="/portfolio" data-aos-delay="300" data-aos="flip-up" className='py-2 px-4 rounded-full text-center bg-emerald-500 text-white hover:cursor-pointer w-52 hover:scale-110 transition-all'>
                    Check Us
                  </Link>
                  <Link href="/contact" data-aos-delay="300" data-aos="flip-up" className='py-2 px-4 rounded-full text-center border-2 border-emerald-500 hover:bg-emerald-500 hover:text-white hover:cursor-pointer w-52'>
                    Contact Us
                  </Link>
                </div>
              </div>
